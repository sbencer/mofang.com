...
function(module) {
  ...
  var resetLabels = countdown.resetLabels = function() {
    ...
    LABELS_SINGLUAR = '毫秒|秒|<b>分</b>|<b>时</b>|<b>天</b>|周|月|年|decade|century|millennium'.split('|');
    // LABELS_PLURAL = 'milliseconds|seconds|minutes|hours|days|weeks|months|years|decades|centuries|millennia'.split('|');
    LABELS_PLURAL = '毫秒|<b class="miao">秒</b>|<b class="fen">分</b>|<b class="shi">时</b>|<b class="tian">天</b>|周|<b class="yue">月</b>|年|decades|centuries|millennia'.split('|');
  };
