define("hw/fixed",["jquery"],function(require,exports,module){
    /**
     * $.fixbox
            ...
            doFix:function () {
                ...
                if (fixedBoxH < (winH - distanceToTop)) {
                    ...
                    if (winST > offsetT) {
                       ...
                       $element.css({"position":"absolute","top":distanceToTop});
                    }
                }
...
define("sidebar",["jquery","hw/fixed"],function(require,exports,module){
    var $ = jquery = require("jquery");
        require("hw/fixed")
    $(".hw-sidebar").fixbox({distanceToTop:571,threshold:8,distanceToBottom:220});
