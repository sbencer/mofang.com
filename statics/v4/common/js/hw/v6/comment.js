        ...
        $.ajax({
            ...
            success: function(res) {
                if(res && res.code==0){
                    //总数
                    if(res.data.total == ''){
                        $(obj).find(".mf-cmt-num span").html("0");
                    }else{
                        $(obj).find(".mf-cmt-num span").html(res.data.total);
                    }
            ...
            for(var i=0;i<data.length;i++){
                ...
                str += '<div class="mf-cmt-list">'
                    +'<p class="mf-user-head" data-pid="'+data[i].pid+'">'
                        +'<img src="'+data[i].user.avatar+'" alt="">'
                    +'</p>'
                    +'<dl class="mf-user-info">'
                        +'<dt><span class="cmt-name">'+data[i].user.nickname+'</span><span class="pc-time">   发表于 : '+formatTime(data[i].create_time)+'</span><span class="m-time r">'+formatTime(data[i].create_time)+'</span></dt>'
                    ...
                    if(res && res.code==0){
                        ...
                        var str = '<div class="mf-cmt-list">'
                            +'<p class="mf-user-head" data-pid="'+res.data.pid+'">'
                                +'<img src="'+res.data.user.avatar+'" alt="">'
                            +'</p>'
                            +'<dl class="mf-user-info">'
                                +'<dt><span class="cmt-name">'+res.data.user.nickname+'</span>   <span class="pc-time">发表于 : '+formatTime(res.data.create_time)+'</span><span class="m-time r">'+formatTime(res.data.create_time)+'</span></dt>'
