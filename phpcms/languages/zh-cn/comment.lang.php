...
$LANG['coment_class_php_2'] = '數據存儲表不存在，並在嘗試創建數據存儲表時出現錯誤，請聯系管理員。';
$LANG['coment_class_php_3'] = '寫入數據存儲表時出錯，請聯系管理員。';
$LANG['coment_class_php_4'] = '自動創建數據存儲表時出錯，請聯系管理員。';
$LANG['coment_class_php_5'] = '嘗試添加評論數據時出錯，請聯系管理員。';
$LANG['coment_class_php_6'] = '評論沒有找到。';
$LANG['coment_class_php_7'] = '評論發表成功，需要等待管理員審核，才會顯示。';
$LANG['phpcms_friends'] = '網友';
$LANG['mf_friends'] = '魔方網網友';
