...
$LANG['account_changes_notice_tips'] = '尊敬的{username},您好！<br/>您的賬戶於{time}發生變動,操作：{op},理由:{note},當前余額：{amount}元，{point}積分。';

//payment.php
$LANG['basic_config'] = '基本設置';
$LANG['contact_email'] = '聯系郵箱';
$LANG['contact_phone'] = '聯系電話';
...
$LANG['alipay_tip'] = '支付寶是國內領先的獨立第三方支付平台，由阿裡巴巴集團創辦。致力於為中國電子商務提供“簡單、安全、快速”的在線支付解決方案。';
...
$LANG['chinabank'] = '網銀在線';
$LANG['chinabank_tip'] = '網銀在線與中國銀行、中國工商銀行、中國農業銀行、中國建設銀行、招商銀行等國內各大銀行，以及VISA、MasterCard、JCB等國際信用卡組織保持了長期、緊密、良好的合作關系。<a href="http://www.chinabank.com.cn" target="_blank"><font color="red">立即在線申請</font>';
