<div class="sort-content clearfix">
    <div class="con-left">
        <div class="sort-head">
            <ul class="clearfix">
                <li class="curr"><a href="{cat_url(10000050)}">綜合</a></li>
                <li><a href="{cat_url(10000051)}">遊戲</a></li>
                <li><a href="{cat_url(10000056)}">情報</a></li>
                <li><a href="{cat_url(10000222)}">姬+</a></li>
            </ul>
        </div>
        <div class="sort-main">
...
{require name="tw_mofang:statics/css/sort_information.css"}
