<div class="v-moke">
	<div class="hw-common-title">
		<a href="{cat_url(10000061)}" target="_blank" class="hw-common-more fr">更多 <em>></em></a>
		<h3>遊戲評鑑</h3>
	</div>
	<div class="hw-common-con">
		<div class="moke-wrap">
			<div class="moke-top clearfix">
				{pc M=content action=lists catid=10000061 field='id,title,url,thumb' order='listorder desc, id desc' num=7}
				{foreach $data as $val}
					{if $val@first}
