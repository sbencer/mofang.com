...
{literal}
<style>
.icon-red {position: absolute;right: 17px;top: 10px;width: 6px;height: 6px;background: url(/statics/v4/common/img/v6/red.png) no-repeat;background-size: 100% 100%;display: none;}
...
.header .nav .header-navr .nav-contact a{   color:#fff;display:inline-block;background: url(/statics/v4/common/img/v6/contact_icon.png) no-repeat;text-indent: -99999px;margin-left:26px;}
...
.header .nav .header-navr .nav-search .search-text{height:16px;width:144px;margin-right:10px;border:0px;float:left;font-size:15px;}
.header .nav .header-navr .nav-search .search-sub{width:16px;height:16px;border:0px;cursor:pointer;background: url(/statics/v4/common/img/v6/search.png) no-repeat;}
...
.icon-money {display: inline-block;width: 18px;height: 18px;margin-right: 6px;margin-bottom: 2px;vertical-align: middle;background: url(/statics/v4/common/img/v6/money.png) no-repeat;background-size: 100% 100%;}
.header .nav .header-navr .top-login a{color:#fff;}
.header .nav .header-navr .top-login a.login-icon{color:#fff;display:inline-block;background: url(/statics/v4/common/img/v6/contact_icon.png) no-repeat;text-indent: -99999px;;
...
.header .nav .header-navr .nav-contact div.weixin-bg{
 ...
 .weixin-box .weixin-img{
  ...
  width: 242px;
  height: 265px;
  background:#fff url(/statics/v4/common/img/v6/weixin-img.jpg) no-repeat;
  text-align: center;
  background-size:100%;
  line-height:490px;
  font-style: normal;
...
<div class="header">
   ...
   <div class="nav clearfix width-1280">
   		<div class="header-navl l">
   			<dl>
   				<dt><a target="_blank" href="http://www.mofang.com"><img src="/statics/v4/common/img/v6/logo.png" alt="魔方网"></a></dt>
   				<dd>
          ...
          <div class="weixin-box"><em class="weixin-img">扫码关注魔方陪你玩</em></div>
			...
			<div class="nav-search">
                ...
                <form action="http://www.mofang.com/tag/*.html" id="search" target="_blank">
                  <input type="text" id="topSearch" value="{$smarty.get.q}" class="search-text" placeholder="请输入搜索内容"/>
