			...
			<div class="hw-login">
				...
				<div class="third-login-wrap">
					...
					<a href="https://twitter.com/mofangjp" class="google-login login-comm">
						<img src="/statics/v4/common/img/hw/v1/new_twitter_03.png" alt="">
					</a>
					<a href="https://www.youtube.com/user/MoFangTW" class="tw-login login-comm">
						<img src="/statics/v4/common/img/hw/v1/youtube_03.png" alt="">
					</a>
				</div>
			</div>
			...
			<ul class="title-diff clearfix">
				...
				<li>
					...
					<div class="dropdown" style="background:#4fd3ce;">
						<a href="javascript:;" class="game coming_soon" data-id="coming_soon">H5 GAME</a>
				...
				<li>
					...
					<div class="dropdown" style="background:#e6d90b;">
						<a href="http://www.mofang.com.tw/acg/" class="acg last">次元角落</a>
					</div>
				</li>
				<li>
