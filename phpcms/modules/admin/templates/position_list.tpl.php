...
function preview(thumb, name) {
	...
	window.top.art.dialog({title:'預覽 '+name+' ',id:'preview',iframe:'?m=admin&c=position&a=preview&thumb='+thumb,width:'530',height:'400'}, '', function(){window.top.art.dialog({id:'preview'}).close()});
}
//-->
</script>