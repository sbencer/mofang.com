...
<!--
	$(function(){
		...
		$('#release_point').formValidator({onshow:"<?php echo L('publishing_sites_to_other_servers')?>",onfocus:"<?php echo L('choose_release_point')?>"}).inputValidator({max:6,onerror:"<?php echo L('most_choose_four')?>"});
