...
<div id="table-lists" class="table-list" >
	...
	<tr>
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('issearch')?>：</b><br>
		<input boxid="issearch" type='radio' name='info[<?php echo $catid;?>][issearch]' value='1' <?php if($cat['issearch']) echo 'checked';?> onclick="change_radio(event,'issearch',1)"> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
		<input boxid="issearch" type='radio' name='info[<?php echo $catid;?>][issearch]' value='0' <?php if(!$cat['issearch']) echo 'checked';?> onclick="change_radio(event,'issearch',0)"> <?php echo L('no');?>
	  </td>
	<?php
		}
	?>
	...
	<tr>
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('is_area_menu')?>：</b><br>
		<input boxid="is_area_menu" type='radio' name='info[<?php echo $catid;?>][is_area_menu]' value='1' <?php if($cat['is_area_menu']) echo 'checked';?> onclick="change_radio(event,'is_area_menu',1)"> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
		<input boxid="is_area_menu" type='radio' name='info[<?php echo $catid;?>][is_area_menu]' value='0' <?php if(!$cat['is_area_menu']) echo 'checked';?> onclick="change_radio(event,'is_area_menu',0)"> <?php echo L('no');?>
	  </td>
	<?php
		}
	?>
