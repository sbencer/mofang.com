...
<table width="100%" class="table_form ">
    ...
    <tr>
     <th><?php echo L('issearch');?>：</th>
      <td>
      <input type='radio' name='info[issearch]' value='1' <?php if($issearch) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
      <input type='radio' name='info[issearch]' value='0' <?php if(!$issearch) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    <tr>
    ...
    <tr>
     <th><?php echo L('is_area_menu');?>：</th>
      <td>
      <input type='radio' name='info[is_area_menu]' value='1' <?php if($is_area_menu) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
      <input type='radio' name='info[is_area_menu]' value='0' <?php if(!$is_area_menu) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    <tr>
     <th><?php echo L('ismobile');?>：</th>
      <td>
      <input type='radio' name='info[ismobile]' value='1' <?php if($ismobile) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
      <input type='radio' name='info[ismobile]' value='0' <?php if(!$ismobile) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
...
<tr>
  <th width="200"><?php echo L('available_styles');?>：</th>
      ...
      <tr>
        <th width="200"><?php echo L('category_index_m_tpl')?>：</th>
        <td id="category_m_template">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <th width="200"><?php echo L('category_list_m_tpl')?>：</th>
        <td  id="list_m_template">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <th width="200"><?php echo L('content_m_tpl')?>：</th>
        <td  id="show_m_template">
        </td>
      </tr>

      <tr>
        <th width="200"><?php echo '禁止加载移动模板';?></th>
        <td><input type='radio' name='setting[mobile_forbid]' value='1' <?php if($setting['mobile_forbid']) echo 'checked';?> > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
          <input type='radio' name='setting[mobile_forbid]' value='0' <?php if(!$setting['mobile_forbid']) echo 'checked';?> > <?php echo L('no');?></td></td>
      </tr>
      <tr>
        <th width="200"><?php echo '模板應用到子欄目';?></th>
...
<!--
    ...
    function load_file_list(id) {
        if(id=='') return false;
        $.getJSON('?m=admin&c=category&a=public_tpl_file_list&style='+id+'&catid=<?php echo $catid?>', function(data){$('#category_template').html(data.category_template);$('#list_template').html(data.list_template);$('#show_template').html(data.show_template);$('#category_m_template').html(data.category_m_template);$('#list_m_template').html(data.list_m_template);$('#show_m_template').html(data.show_m_template);});
    }
