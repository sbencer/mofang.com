...
<link href="http://www.test.mofang.com.tw/statics/css/dialog.css" rel="stylesheet" type="text/css">
...
<tr>                                                                                                                                                                         
    <td width="80"><?php echo L('userimage')?></td>
    <td><?php echo form::images('info[avatars]', 'thumb', $avatars, 'avatars','','','');?></td>
</tr>
<tr>                                                                                                                                                                         
    <td width="80"><?php echo L('description')?></td>
    <td>
    <input type="text" name="info[description]" id="description" class="input-text" size="80" value="<?php echo $description?>"></input>
    </td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" src="http://www.test.mofang.com.tw/statics/js/dialog.js"></script>
</html>
