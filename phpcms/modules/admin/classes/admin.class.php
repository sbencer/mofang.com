...
class admin {
	...
	final public function check_admin() {
		if (isset($_SERVER['HTTP_MOFANG_COLLECT']) && $_SERVER['HTTP_MOFANG_COLLECT'] == 1) {
			$_SESSION = array ( 'code' => 'collect', 'userid' => '5', 'roleid' => '8', 'pc_hash' => 'MFCollect', 'siteid' => '1', 'lock_screen' => 0);
		}
	...
	/**
	 * 獲取當前站點信息
	 * @param integer $siteid 站點ID號，為空時取當前站點的信息
	 * @return array
	 */
	...
	final public function check_priv() {
        // 專區文章排序權限不限制
        if(ROUTE_M =='partition' &&ROUTE_C =='content' && ROUTE_A == 'listorder') return true;
		if(ROUTE_M =='admin' && ROUTE_C =='index' && in_array(ROUTE_A, array('login', 'init', 'public_card', 'listorder'))) return true;
