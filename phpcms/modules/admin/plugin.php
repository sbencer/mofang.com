...
class plugin extends admin {
	...
	public function install_online() {
		...
		//如果為iframe類型應用，無需下載壓縮包，之間創建插件文件夾
...
return array (
  ...
  'plugin'=> array(
   ...
   'plugin_var'=> array(   array('title'=>'寬度','description'=>'','fieldname'=>'width','fieldtype'=>'text','value'=>'960','formattribute'=>'style="width:50px"','listorder'=>'1',),		array('title'=>'高度','description'=>'','fieldname'=>'height','fieldtype'=>'text','value'=>'640','formattribute'=>'style="width:50px"','listorder'=>'2',),   
	),	
);
?>				
EOF;
