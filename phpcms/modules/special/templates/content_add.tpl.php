...
<table width="100%" cellspacing="0" class="table_form">
	...
	<tr>
      ...
      <td><input type="text" style="width:350px;" name="info[title]" id="title" class="measure-input "/>
    ...
    <tr>
      <th width="80"> 短標題	  </th>
      <td><input type='text' name='info[short_title]' id='short_title' value='' style='50'  ></td>
    </tr>
    <tr>
