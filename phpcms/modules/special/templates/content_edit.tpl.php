...
<table width="100%" cellspacing="0" class="table_form">
	...
	<tr>
      ...
      <td><input type="text" style="width:350px;" name="info[title]" id="title" value="<?php echo htmlspecialchars($info['title'])?>" class="measure-input " />
    ...
    <tr>
      <th width="80"> 短標題	  </th>
      <td><input type='text' name='info[short_title]' id='short_title' value='<?php echo htmlspecialchars($info['short_title'])?>' style='50'  ></td>
    </tr>
    <tr>
	...
	<tr>
      ...
      <td><textarea name="info[description]" id="description" style='width:98%;height:46px;' onkeyup="strlen_verify(this, 'description_len', 255)"><?php echo $info['description']?></textarea> 還可輸入<B><span id="description_len"><?php echo 255-strlen($info['description'])?></span></B> 個字符  </td>
    </tr>
	<tr>
...
document.title='編輯：<?php echo $info['title']?>';
self.moveTo(0, 0);
