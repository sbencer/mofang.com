...
<div class="pad-10">
<form method="post" action="?m=partition&c=activity&a=add&pc_hash=<?php echo $_SESSION['pc_hash'];?>" name="myform" id="myform" enctype="multipart/form-data">

	<table class="table_form" width="100%" cellspacing="0">
    <input name="activity[pid]" type="hidden" value="<?php echo $_GET['catid']?>">
	<tbody>
		<tr>
			<th width="80"><strong><?php echo L('activety_title')?>：</strong></th>
			<td><input name="activity[title]" id="title" class="input-text" type="text" size="30" ></td>
			<td></td>
		</tr>
		...
		<tr>
			...
			<td><input name="activity[url]" id="title" class="input-text" type="text" size="30" ></td>
			<td></td>
		</tr>
		...
		<tr>
            ...
            <td><input name="activity[limit_time]" <?php if(!empty($rule_json['mozuan_need_value'])) echo "checked";?> type="checkbox"/></td>
		</tr>

		<tr>
			<th><strong><?php echo L('startdate')?>：</strong></th>
			<td><?php echo form::date('activity[start_time]', date('Y-m-d H:i:s'), 1)?></td>
			<td></td>
		</tr>

		<tr>
			<th><strong><?php echo L('enddate')?>：</strong></th>
			<td><?php echo form::date('activity[end_time]', date('Y-m-d H:i:s'), 1);?></td>
			<td></td>
		</tr>
