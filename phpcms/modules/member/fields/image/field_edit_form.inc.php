...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>圖像大小</td>
      <td>寬 <input type="text" name="setting[images_width]" value="<?php echo $setting['images_width'];?>" size="3">px 高 <input type="text" name="setting[images_height]" value="<?php echo $setting['images_height'];?>" size="3">px</td>
    </tr>
</table>