...
class collection {
	...
	/**
	 * 採集內容
	 * @param string $url    採集地址
	 * @param array $config  配置參數
	 * @param integer $page  分頁採集模式
	 */
	 ...
	 * 
	 * HTML切取
	 * @param string $html    要進入切取的HTML代碼
	...
	/**
	 * 過濾代碼
	 * @param string $html  HTML代碼
	 * @param array $config 過濾配置
	 */
