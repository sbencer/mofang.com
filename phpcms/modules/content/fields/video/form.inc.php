...
var js4swf = {
...

    {
        ...
        // 初始化時調用, 若 list.length > 0 代表有可續傳文件
...
$("#list_name").html("'.L('file', '', 'video').'"+list[length].name+"'.L('failed_uplaod_choose_again', '', 'video').'");
...

    {
        ...
        // 獲得 sid 後返回, 更新 sid 用 (key, sid, name, type, size)
...
$("#video_title").val(evt.name);
...

    {
        ...
        // 上傳進度事件 (bytesLoaded, bytesTotal, speed) m=1 時沒有這事件
