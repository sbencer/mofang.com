...
<table cellpadding="2" cellspacing="1" bgcolor="#ffffff">
	...
	<tr>
      ...
      <td>
	  <input type="radio" name="setting[defaulttype]" value="0" <?php if($setting['defaulttype']=='0') echo 'checked';?>/>無<br />
	  <input type="radio" name="setting[defaulttype]" value="1" <?php if($setting['defaulttype']=='1') echo 'checked';?>/>當前時間<br />
	 </td>
    </tr>
</table>