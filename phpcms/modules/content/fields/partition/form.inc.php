	...
	function partition($field, $value, $fieldinfo) {
		extract($fieldinfo);
		...
		<div>
<input type='button' value='添加{$name}' onclick=\"omnipotent('select_{$field}','?m=content&c=content&a=public_mfrelation&modelids={$modelids}&field={$field}&type={$relationtype}','選擇{$name}',1)\" class='button'>
