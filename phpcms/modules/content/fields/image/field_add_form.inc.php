<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>表單顯示模式</td>
      <td><input type="radio" name="setting[show_type]" value="1" /> 圖片模式 <input type="radio" name="setting[show_type]" value="0" checked/> 文本框模式</td>
    </tr>
	<tr> 
      <td>允許上傳的圖片類型</td>
	...
	<tr> 
      <td>圖像大小</td>
      <td>寬 <input type="text" name="setting[images_width]" value="" size="3" class="input-text">px 高 <input type="text" name="setting[images_height]" value="" size="3" class="input-text">px</td>
    </tr>
</table>