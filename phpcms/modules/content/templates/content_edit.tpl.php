...
$(
	function(){
		$("#parentid_f").val(<?php echo $sub_id[1]; ?>).attr("selected",true);
		$("#parentid_s").val(<?php echo $partition_info['part_id']; ?>).attr("selected",true);
	}
)
	...
	function(){
		...
		$.ajax({
			...
			success: function( data  ){
				...
				$("#parentid_f").nextAll().remove();
				$("#parentid_f").after(data);
			}
