...
<div id="pages" class="text-c"> <label class="cu" onclick="Selectd(1);">全選</label>/<label class="cu" onclick="Selectd(0);">取消</label> <?php echo $pages?></div>
