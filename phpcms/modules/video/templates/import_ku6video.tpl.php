...
<tbody>
    ...
    <div class="btn"><label for="check_box"><?php echo L('selected_all');?>/<?php echo L('cancel');?></label>
		...
		<input type="radio" name="is_category" value="0" checked="1" id="no_category" onclick="$('#show_category').css('display','none');">只入庫
...
function preview(vid, name) {
	...
	window.top.art.dialog({title:'預覽 '+name+' ',id:'preview',iframe:'?m=video&c=video&a=preview_ku6video&ku6vid='+vid,width:'530',height:'400'}, '', function(){window.top.art.dialog({id:'preview'}).close()});
}
