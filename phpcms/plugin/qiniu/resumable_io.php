...
class Qiniu_Rio_PutExtra
{
	public $Bucket = null;		// 必選（未來會沒有這個字段）。
	public $Params = null;
	public $MimeType = null;
	public $ChunkSize = 0;		// 可選。每次上傳的Chunk大小
	public $TryTimes = 3;		// 可選。嘗試次數
	public $Progresses = null;	// 可選。上傳進度：[]BlkputRet
	public $Notify = null;		// 進度通知：func(blkIdx int, blkSize int, ret *BlkputRet)
	public $NotifyErr = null;	// 錯誤通知：func(blkIdx int, blkSize int, err error)
