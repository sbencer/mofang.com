...
defined("MFE_LOCAL") || DEFINE('MFE_SMARTY_TEMPLATES', MFE_BASE_PATH."..".DIRECTORY_SEPARATOR. "phpcms".DIRECTORY_SEPARATOR. "templates".DIRECTORY_SEPARATOR."v3".DIRECTORY_SEPARATOR);
// 是否啟啟用模板調試
...
$smarty->setCompileDir(PHPCMS_PATH.'caches'.DIRECTORY_SEPARATOR."templates_c".DIRECTORY_SEPARATOR."v3");
