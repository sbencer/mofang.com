	...
	class YITH_WACP_Frontend {
		...
		public function add_to_cart_success_ajax( $datas ) {
			...
			<div class="actions">
				...
				<?php endif ?>
				<?php if( $continue ) : ?>
				<?php $current_page_url = get_site_url(); ?>
					<a class="<?php echo apply_filters( 'yith_wacp_continue_shopping_class', 'button continue-shopping' ) ?>" href="<?php echo $current_page_url; ?>" onClick="window.location.reload();"><?php _e( 'Continue shopping', 'yith-wacp' ) ?></a>
				<?php endif; ?>
			</div>
