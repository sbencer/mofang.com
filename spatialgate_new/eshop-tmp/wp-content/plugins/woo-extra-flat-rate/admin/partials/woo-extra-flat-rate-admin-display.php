	...
	public function settings_page() { 
		...
		<tr valign="top" class="">
						<th scope="row" class="titledesc">
							<label for="woocommerce_shipping_method_format">Shipping Display Mode</label>
						</th>
						<td class="forminp forminp-radio">
							<fieldset>
																<ul>
																		<li>
											<label>
											<input name="md_woocommerce_shipping_method_format" value="radio"  type="radio" style="" class="" <?php echo ($chk =='radio' ? 'checked' : '');?>> Display shipping methods with "radio" buttons</label>
										</li>
																				<li>
											<label><input name="md_woocommerce_shipping_method_format" value="select"  type="radio" style="" class="" <?php echo ($chk =='select' ? 'checked' : '');?>> Display shipping methods in a dropdown</label>
										</li>
																		</ul>
							</fieldset>
						</td>
		...
		<tr>
		<td colspan="2">
		<input type="submit" class="button-primary" name="btn_shipping" value="Save Display Mode"/>
		</td>
		</tr>
					</table>
