...
class WCVendors_Pro_Shop_Coupon_Controller {
	...
	public function process_submit() { 
		...
		// Allow different vendors to use the same coupon title or do we prefix all coupon codes with shop title/id ? 
		//  Discuss with Ben regarding this. 

		// Requires a coupon code to be unique 
		if ( 0 !== $coupon_id ) { 
	 ...
	 */
	public function coupon_exists( $coupon_title, $coupon_id ) { 
