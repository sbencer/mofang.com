		...
		<tbody>
			...
			<?php if ( $shipping_rates ) : ?>
				...
				<tr>
					...
					<td class="fee"><input type="text" placeholder="<?php _e( "Fee", 'wcvendors-pro' ); ?>" name="_wcv_shipping_fees[]" value="<?php echo esc_attr( $rate['fee'] ); ?>" /></td>
				...
				<th colspan="5">
					...
					<?php
						...
						$file_data_row = '<tr>
							...
							<td class="fee"><input type="text" placeholder="'. __( "Fee", "wcvendors-pro" ). '" name="_wcv_shipping_fees[]" value="'. esc_attr( $rate["fee"] ) .'" /></td>
							<td width="1%"><a href="#" class="delete"><i class="fa fa-times"></i></a></td>
						</tr>';
