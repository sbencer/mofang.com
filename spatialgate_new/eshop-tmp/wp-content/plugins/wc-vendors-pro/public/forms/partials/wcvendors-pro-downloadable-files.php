...
<div class="show_if_downloadable">
		...
		<table >
			<thead>
				<tr>
					...
					<th colspan="2"><?php _e( 'File URL', 'wcvendors-pro' ); ?> <span class="tips" data-tip="<?php _e( 'This is the URL or absolute path to the file which customers will get access to.', 'wcvendors-pro' ); ?>">[?]</span></th>
					<th>&nbsp;</th>
				</tr>
			</thead>
			<tbody>
				...
				<?php if ( $downloadable_files ) : ?>
					...
					<tr>
						...
						<td class="file_name"><div class="control-group"><div class="control"><input type="text" class="input_text" placeholder="<?php _e( 'File Name', 'wcvendors-pro' ); ?>" name="_wc_file_names[]" value="<?php echo esc_attr( $file['name'] ); ?>" /></div></div></td>
						<td class="file_url"><input type="text" class="input_text" placeholder="<?php _e( "http://", 'wcvendors-pro' ); ?>" name="_wc_file_urls[]" value="<?php echo esc_attr( $file['file'] ); ?>" /></td>
	...
	<td class="file_url"><div class="control-group"><div class="control"><input type="text" class="input_text" placeholder="'. __( 'http://', 'wcvendors-pro' ). '" name="_wc_file_urls[]" value="' . esc_attr( $file['file'] ). '" /></div></div></td>
