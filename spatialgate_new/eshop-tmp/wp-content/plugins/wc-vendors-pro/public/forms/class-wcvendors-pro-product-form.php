...
class WCVendors_Pro_Product_Form {
	 ...
	 * @param 	 int 	$post_id  post_id for this meta if any 
	 */
	public static function form_data( $post_id ) {
	...
	public static function save_button( $button_text ) {
		...
		if ( !$can_edit ) $button_text = __( 'Save Pending', 'wcvendors-pro' ); 
	...
	/**
	 * Output a woocommerce attribute selects 
	 *
	 * @since      1.0.0
	 ...
	 * @param 	 int 	$post_id  post_id for this meta if any 
	 */
	public static function grouped_products( $post_id ) {
	...
	public static function shipping_rates( $post_id ){ 
		...
		$store_shipping_type	= get_post_meta( $store_id, '_wcv_shipping_type', true ); 
