...
<div class="wcv-shade wcv-fade">
	...
	<div id="order-details-modal-<?php echo $order_id; ?>" class="wcv-modal wcv-fade" data-trigger="#open-order-details-modal-<?php echo $order_id; ?>" data-width="80%" data-height="90%"  data-reveal aria-labelledby="modalTitle-<?php echo $order_id; ?>" aria-hidden="true" role="dialog">
			...
			<div class="modal-header">
		            ...
		            <h3 id="modal-title"><?php echo sprintf( __( 'Order #%d Details', 'wcvendors-pro'), $order_id ); ?> - <?php echo date_i18n( wc_date_format(), strtotime( $order->order_date ) );  ?></h3>
		    </div>
						...
						<div class="all-100">
					    	...
					    	<table cellpadding="0" cellspacing="0" class="wcv-table wcv-order-table">
								<thead>
									...
									<tr>
										<td class="wcv-order-totals-label" colspan="6"><?php _e( 'Shipping', 'wcvendors-pro' ); ?>:</td>
										...
										<?php if ( wc_tax_enabled() ) : ?>
											<?php foreach ( $order->get_tax_totals() as $code => $tax ) : ?>
												<tr>
													<td class="wcv-order-totals-label" colspan="6"><?php echo $tax->label; ?>:</td>
													<td class="total"><?php
										...
										<tr>
											<td class="wcv-order-totals-label" colspan="6"><?php _e( 'Commission Total', 'wcvendors-pro' ); ?>:</td>
											<td class="total"><div class="view"><?php echo wc_price( $_order->commission_total, array( 'currency' => $order->get_order_currency() ) ); ?></div></td>
										</tr>
										<tr>
											<td class="wcv-order-totals-label" colspan="6"><?php _e( 'Order Total', 'wcvendors-pro' ); ?>:</td>
