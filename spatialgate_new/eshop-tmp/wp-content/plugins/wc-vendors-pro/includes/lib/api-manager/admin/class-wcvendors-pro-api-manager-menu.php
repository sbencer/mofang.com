		...
		<div class='wrap'>
			...
			?>
				...
				<form action='options.php' method='post'>
					<div class="main">
					<div class="notice">
					<?php _e( 'If you are having any problems with activation, please visit your <a href="https://www.wcvendors.com/my-account/" target="_blank">my account</a> page to reset your activation.', 'wcvendors-pro'); ?>
					</div>
				<?php
