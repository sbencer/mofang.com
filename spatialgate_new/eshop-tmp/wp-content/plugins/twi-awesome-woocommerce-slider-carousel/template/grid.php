...
<ul class="twi-grid woocommerce <?php if($twi_full=='yes'){ echo 'twi-forced-fullwidth';}else{ echo 'undefine'; } ?> twi-grid-width-xlarge-1-<?php echo $xlarge; ?> twi-grid-width-large-1-<?php echo $large; ?> twi-grid-width-medium-1-<?php echo $medium; ?> twi-grid-width-small-1-<?php echo $small; ?> twi-grid-width-1-<?php echo $default; ?> twi-grid-<?php echo $gap; ?> twi-grid-match" data-twi-grid-margin>
	<?php
    require (TWI_AWESOME_WOO_SLIDER_CAROUSEL_DIR .'/template/query/query.php');
