...
if ( ! function_exists( 'storefront_setup' ) ) :
	...
	function storefront_setup() {
		...
		// http://jetpack.me/
		add_image_size( 'logo_mofang' , 270,79 );
		add_theme_support( 'site-logo', array( 'size' => 'logo_mofang' ) );
...
function storefront_widgets_init() {
	...
	$footer_widget_regions = apply_filters( 'storefront_footer_widget_regions', 5 );
