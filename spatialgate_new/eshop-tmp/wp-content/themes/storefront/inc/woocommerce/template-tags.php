...
if ( ! function_exists( 'storefront_cart_link' ) ) {
	function storefront_cart_link() {
		?>
			<img src="http://www.spatialgate.com.tw/eshop/wp-content/uploads/2016/03/pic_cart.jpg" width="34" height="32" alt=""/>
			<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( '觀看你的購物車', 'storefront' ); ?>">
				</span> <span class="count"><?php echo wp_kses_data( sprintf( _n( '共 %d 件商品', '共 %d 件商品', WC()->cart->get_cart_contents_count(), 'storefront' ), WC()->cart->get_cart_contents_count() ) );?></span>
			</a>
		<?php
	}
}
...
if ( ! function_exists( 'storefront_product_search' ) ) {
	function storefront_product_search() {
		if ( is_woocommerce_activated() ) { ?>
			  <HR class ="hrheight" width="100%" align="center">
...
if ( ! function_exists( 'storefront_header_cart' ) ) {
	function storefront_header_cart() {
		...
		<ul class="site-header-cart menu">
			<li>	
				<img src="http://www.spatialgate.com.tw/eshop/wp-content/uploads/2016/03/lan_tai.jpg" width="18" height="18" alt=""/>
        		哈囉 <b><?php echo $name; ?>  
       			 <a href="<?php echo wp_logout_url( 'http://www.spatialgate.com.tw/eshop/' ); ?>">登出</a>
        	</li>
        </ul>
		<?php } 
		else
	    ...
	    <ul class="site-header-cart menu">
			<li>
				<img src="http://www.spatialgate.com.tw/eshop/wp-content/uploads/2016/03/lan_tai.jpg" width="18" height="18" alt=""/>
        		哈囉 <b>Guset</b> 
        		<a href="<?php echo get_option('siteurl'); ?>/我的頁面/">  登入 </a> ｜ <a href="<?php echo get_option('siteurl'); ?>/我的頁面/"> 註冊 </a>
			</li>
        </ul>
		<?php } ?>
		<ul class="site-header-cart menu">
