define('jquery/Slider',['jquery'],function(require, exports, module) {
    ...
    (function(w, $, document) {
        ...
        methods.destroy = function() {
            return this.each(function() {
                var $box = $(this),
                    data = $box.data() || {}, settings = data.bssettings;
        ...
        var vendorPrefix = (function() {
            ...
            var bs = document.body.style || document.documentElement.style,
                prefix = '';
