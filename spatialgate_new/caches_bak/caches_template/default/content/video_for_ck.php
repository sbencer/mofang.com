    	...
    	<div class="l">
        	...
        	<div class="r2">
				...
				<?php $n=1;if(is_array($infos)) foreach($infos AS $info) { ?>
                    <li><div class="w9"><a href="javascript:void(0);" title="<?php echo $info['title'];?>" data-vid="<?php echo $info['vid'];?>" onclick="a_click(this);"><span></span><img src="<?php echo $info['picpath'];?>" width="90" height="51" /></a><p><?php echo str_cut($info['title'], 18);?></p></div></li>
				<?php $n++;}unset($n); ?>
				<?php } else { ?>
					&nbsp;&nbsp;&nbsp;&nbsp;视频库中没有您的视频，请先上传视频！
				<?php } ?>
...
var okListener = function(event){
	...
	if (video_url=='') {
		...
		video_url = '<embed src="<?php echo $player_url;?>'+video_url+'/style/<?php echo $video_setting['style_projectid'];?>/" quality="high" width="414" height="305" align="middle" allowScriptAccess="always" allowfullscreen="true" flashvars="auto=1" type="application/x-shockwave-flash"></embed>';
