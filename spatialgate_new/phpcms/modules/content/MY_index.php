...
class MY_index extends index {
    ...
    public function comics_list() {
		...
		if($type==0) {
            ...
            if($this->_is_wap) {
                ...
                if($modelid == 14) {
                    $smarty->display('tw_acg/widget/comics_works.tpl');
                }
            }
        }
    }
	...
	public function show_comics() {
        ...
        if($this->_is_wap) {
            ...
            if($_GET['format'] == 'html') {
                $smarty->display('tw_acg/widget/comics/comics_works.tpl');
                return;
            }
            $templates = STYLE.DIRECTORY_SEPARATOR.$template;
            if($id==25){
