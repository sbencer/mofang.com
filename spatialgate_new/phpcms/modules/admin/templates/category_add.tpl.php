...
<tr>
	...
	<tr>
		...
		<td>
			<input type='radio' name='info[issearch]' value='1' > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type='radio' name='info[issearch]' value='0' checked> <?php echo L('no');?></td>
	</tr>
	<tr>
        <th><?php echo L('posid')?>：</th>
        <td><input type="text" name="info[posid]" id="catdir" class="input-text" value="0"></td>
    </tr>
</table>
