...
{head}
    ...
    {require name="common:statics/css/wap/reset.css"}
    {require name="common:statics/css/wap/common.css"}
...
{body}
    ...
    {block name=body}
    {strip}{if $smarty.const.BAIDU_WAP_STATICSTICS_CODE}
        <img src="{$smarty.const.BAIDU_WAP_STATICSTICS_CODE}" style="display:none;">
    {/if}{/strip}
