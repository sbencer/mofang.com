  ...
  <div class="infobox" id="fmBox">
      ...
      <div class="register_cont" id="login-cont">
        <div class="before">
          ...
          <form>
            <div class="login"><label class="input_tips">{t}邮箱{/t}</label><span class="img01"></span><input id="accountLogin" type="text" value=""></div>
      ...
      <div class="register_cont" style="display:none" id="register-cont">
        ...
        <div class="reginfo">
          <ul>
            ...
            <li><label class="input_tips">{t}输入密码{/t}</label><span class="passwd">{t}密码{/t}</span>&nbsp;<input id="userPasswordReg" type="password" value=""></li>
...
{require name="common:statics/css/login_jp.css"}
  ...
  {require name="common:statics/js/login_jp.js"}
  {script}
    seajs.use(["login_jp/check","mf/login_jp"]);
  {/script}
{else}
  {require name="common:statics/css/login_en.css"}
  {require name="common:statics/js/login_check_en.js"}
  {require name="common:statics/js/login_en.js"}
  {script}
    seajs.use(["login_en/check","mf/login_en"]);
  {/script}
{/if}
